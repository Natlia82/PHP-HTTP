...
<body>
  <form action="" method="post">
    ...
    <input type="text" placeholder="Например, Иванов" required name="family">
    <br>
    <br>
    <span>Введите имя:     </span>
    <input type="text" placeholder="Например, Сергей" required name="nam">
    <br>
    <br>
    <?php
     $n = 0;
     ...
     foreach ($array as $value) {
       ...
       if (isset($_POST[$lll])) {
         $family = $_POST['family'];
         $nam = $_POST['nam'];
         $_SESSION['fio'] = $_POST['family'].' '.$_POST['nam'];
